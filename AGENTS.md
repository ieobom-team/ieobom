...
| ID | 내용 |
|---|---|
| R-01 | 인계 정보 입력 및 AI 구조화 — 텍스트 입력 우선, 체크 입력. 음성 입력은 P1 |
| R-02 | 어르신별 인계 카드 — 대상 · 시간 · 변화 · 조치 · 다음 행동 + **원문 근거 표시** |
| R-03 | 후속 업무 닫힌 루프 — 담당자 지정, 미처리/완료 상태, **대리 완료 처리** |
| R-04 | 기존 업무 연결 — 전산 붙여넣기용 정제 텍스트 생성·복사 |
